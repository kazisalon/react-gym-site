...
const Trainers = () => {
    return (
        <section className="trainers" css={styles}>
            ...
            <Container>
                <TrainerCard trainerImg={Trainer3} trainerName="Supriya" trainerType="Woman Trainer" />
                <TrainerCard trainerImg={Trainer1} trainerName="Ashish Dhakal" trainerType="Men Trainer" />
                <TrainerCard trainerImg={Trainer2} trainerName="Salon Rai" trainerType="Men Trainer" />
            </Container>
        </section>
    )
}
